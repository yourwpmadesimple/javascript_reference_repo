...
// name, volume, color, pocketNum, strapLengthL, strapLengthR, lidOpen, dateAcquired, image
...
const content = `
    ...
    <ul class="backpack__features">
      <li class="feature backpack__volume">Volume:<span> ${everydayPack.volume}l</span></li>
      <li class="feature backpack__color">Color:<span> ${everydayPack.color}</span></li>        
